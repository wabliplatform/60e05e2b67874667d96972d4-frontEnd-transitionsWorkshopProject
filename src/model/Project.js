...
class Project {
     ...
     */
    constructor(pImage, pTitle, pEnd, pWebsite, pStart, pDuration, pGA, pWorkpackage, pDeliverable, pAbstract, pDescription) { 
        
        Project.initialize(this, pImage, pTitle, pEnd, pWebsite, pStart, pDuration, pGA, pWorkpackage, pDeliverable, pAbstract, pDescription);
    }
     ...
     */
    static initialize(obj, pImage, pTitle, pEnd, pWebsite, pStart, pDuration, pGA, pWorkpackage, pDeliverable, pAbstract, pDescription) { 
        obj['pImage'] = pImage;
        obj['pTitle'] = pTitle;
        obj['pEnd'] = pEnd;
